...
const fetchToken = fetchData(apiCalls.fetchToken,
    fromReducers.getIsFetchingAuth, types.CREDENTIALS_FETCH);
const fetchProjects = fetchData(apiCalls.fetchProjects,
    fromReducers.getProjectsIsFetching, types.PROJECTS_FETCH,
    schema.arrayOfProjects);
const fetchJobs = fetchData(apiCalls.fetchJobs, fromReducers.getJobsIsFetching,
    types.JOBS_FETCH, schema.arrayOfJobs);

const fetchProject = fetchData(apiCalls.fetchProject,
    fromReducers.getProjectIsFetching, types.PROJECT_FETCH, schema.project);
const fetchJob = fetchData(apiCalls.fetchJob, fromReducers.getJobIsFetching,
    types.JOB_FETCH, schema.job);

const postProject = fetchData(apiCalls.postProject,
    fromReducers.getProjectIsFetching, types.PROJECT_FETCH, schema.project);

const paginateProjects = fetchData(apiCalls.paginate,
    fromReducers.getProjectsIsFetching, types.PROJECTS_FETCH,
    schema.arrayOfProjects);
