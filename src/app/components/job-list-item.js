...
const JobListItem = (props) => <div className='list-item job-list-item'>
    ...
    <Text>Project: <Link to={'/project/' + props.project__id}>{props.project__title}</Link></Text>
    <Text>Estimated Time: {props.estimated_time} / Logged Time: {props.logged_time}</Text>
    <Text>Description: {props.description}</Text>
    <Text>Status: {props.status__title} / Deadline: <Date date={props.deadline} format={'Do MMMM YYYY'}/></Text>
